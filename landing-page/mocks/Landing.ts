...
export const mockLanding: LandingResponse = {
  ...
  data: {
    ...
    offer: {
      ...
      description: "Automate your advertising campaigns using AI.",
      category: "AI",
      status: "published",
    },
    sections: [
          ...
          items: [
            {
              ...
              description: "Automate repetitive campaign management.",
            },
            {
              title: "Performance Optimization",
              description: "Improve campaign efficiency with AI suggestions.",
            },
            {
              title: "Easy Setup",
              description: "Get started within minutes.",
            },
          ],
        },
      },
      ...
      },
      {
        ...
        settings: {
          ...
          subtitle: "Professionals use AI to simplify advertising.",
          items: [
            {
              name: "Sarah Johnson",
            ...
            },
            {
              name: "Michael Brown",
              role: "Entrepreneur",
              message: "Simple to use and surprisingly powerful.",
            },
          ],
        },
      },
      ...
      },
      {
        ...
        isActive: true,
        settings: {
          title: "Start Automating Your Advertising Today",
          subtitle:
